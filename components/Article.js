...
const data = [{
    ...
    },
    {
        ...
        secondParagraph: `The fundamental problems confronting humanity today flow from the reality that most of the world’s productive wealth—the product of socialized labor and nature—is privately owned and controlled by a tiny minority. This minority decides what will be produced and what will not. Its decisions are based on making profits rather than meeting human needs.`,

        thirdParagraph: `For the great majority of people in the world, including tens of millions of workers in the United States, conditions of life and work are worsening. There is no prospect that this situation can or will be turned around under the existing system.`
    },
    {
        title: 'Cuttlefish',
        date: 'June 27th, 1824',
...
function articleMaker(artinfo) {
    ...
    b.setAttribute('class', 'expandButton');
    art.appendChild(title).textContent = artinfo.title;
    art.appendChild(date).textContent = artinfo.date;
    art.appendChild(p1).textContent = artinfo.firstParagraph;
...
data.forEach((arrayItem) => {
    let newArt = articleMaker(arrayItem);
